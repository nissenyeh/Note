...
- 餐飲平均凈利潤率一般在8-10%，因此我們定義`市場潛力`大約等於「需求量 X 平均單價 X 8-10%」
...
可以「河北區」作為進入的區域，因為
- 雖然天津市具有告需求量，但「河北區」沒有其他自助餐的競爭對手
- 考量到消費力，可以發現「河北區」的人均消費力也最高
  -  我們以區域的「餐廳平均消費額」作為人均消費力的指標


- SQL指令:列出天津區「有販售自助餐的所有區域」
![RelationShip](./03.png)
```sql
